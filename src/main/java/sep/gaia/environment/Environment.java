...
public class Environment {
	...
	public String getString(EnvVariable var) {
		...
		case MARKER_TEXTURE_FILE: return "" + System.getProperty("file.separator") + "marked.png";
		...
		case WEATHER_FONT: return "" + System.getProperty("file.separator") + "fonts" + System.getProperty("file.separator") + "weather_font.ttf";
		case WEATHER_ICONS_DAY: return "" + System.getProperty("file.separator") + "weather_icons" + System.getProperty("file.separator") + "day";
		case WEATHER_ICONS_NIGHT: return "" + System.getProperty("file.separator") + "weather_icons" + System.getProperty("file.separator") + "night";
		case WIKIPEDIA_TEXTURE_FILE: return "" + System.getProperty("file.separator") + "wikipedia.png";
		case POI_TEXTURE_DIR: return "" + System.getProperty("file.separator") + "poi" + System.getProperty("file.separator");
		case IMAGES: return "" + System.getProperty("file.separator") + "images";
		case ICONS: return "res" + System.getProperty("file.separator") + "icons";
		case COMPASS_TEXTURE_FILE: return "" + System.getProperty("file.separator") + "compass.png";
		case SCREENSHOT_BLEND_TEXTURE: return "" + System.getProperty("file.separator") + "scrsht_blend.png";
		case CREDITS_TEXTURE_FILE: return "" + System.getProperty("file.separator") + "credits.png";
		case OSM_COPYRIGHT_TEXTURE_FILE: return "" + System.getProperty("file.separator") + "osmcpy.png";
