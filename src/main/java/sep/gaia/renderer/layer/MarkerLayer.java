...
/**
 * The marker option save marked places persistant. If the persistant marked
 * places occur in the current map section, they will be displayed by a
 * graphical icon.
 * 
...
public class MarkerLayer extends AbstractLayer {
	...
	/**
	 * The adapter used by this layer for converting coordinates of markers and
	 * creating the markers texture.
	 */
	 ...
	 */
	public MarkerLayer(MarkerAdapter adapter) {
